...
let dataset = [{
  ...
  },
  {
    ...
    image: ["Print1.jpg", ],
    date: new Intl.DateTimeFormat('en-US', options).format(new Date(2016,1,20)),
  ...
  },
  {
    ...
    date: new Intl.DateTimeFormat('en-US', options).format(new Date(2020, 5, 4)),
    description: "Streamgraph showing my top 20 artists I listened to on Spotify during the first half of 2020, interpolated with some life events that happened along the way."
  },
  {
    id: 13,
    name: "Fashion Gif",
  ...
  },
  {
    ...
    image: ["BlueMan.jpg", ],
    date: new Intl.DateTimeFormat('en-US', options).format(new Date(2016,4,16)),
  ...
  },
  {
    ...
    image: ["Sketchbook-2.jpg","Sketchbook-3.jpg","Sketchbook-4.jpg","Sketchbook-5.jpg","Sketchbook-6.jpg","Sketchbook-7.jpg","Sketchbook-8.jpg", ],
    date: new Intl.DateTimeFormat('en-US', options).format(new Date(2020,4)),
  ...
  },
  {
    ...
    category: ["photo", "film", "color", "kiev88", "2020", ],
    image: ["Kiev4_1.jpg","Kiev4_2.jpg","Kiev4_3.jpg","Kiev4_4.jpg","Kiev4_5.jpg" ],
    date: new Intl.DateTimeFormat('en-US', options).format(new Date(2020,9,6)),
