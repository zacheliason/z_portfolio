...
<div id="subpage" class="homelist">
  ...
  -->
    <h1 class="disappear">Hello! This is where I keep my design portfolio and coding repository. Feel free to take a look around!
    </h1>
  </div>
...
export default {
  ...
  methods: {
    goTo(item) {
      this.$root.$data.selectCategory = item.category[0];
    ...
    sortItems() {
      return this.$root.$data.items.sort(function(a, b) {
